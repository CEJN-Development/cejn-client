...
// .svelte-kit/output/server/chunks/__layout-2f514da9.js
var layout_2f514da9_exports = {};
__export(layout_2f514da9_exports, {
  default: () => _layout
});
var import_cookie, getStores, page, css$1, Header, css, _layout;
var init_layout_2f514da9 = __esm({
  ".svelte-kit/output/server/chunks/__layout-2f514da9.js"() {
    init_shims();
    init_app_5b189048();
    ...
    css$1 = {
      code: 'header.svelte-c7d174.svelte-c7d174{display:flex}nav.svelte-c7d174.svelte-c7d174{display:grid;grid-template-areas:"logo expander";grid-template-columns:1fr 1fr;width:100%;max-width:100vw;max-height:4rem}#links.svelte-c7d174.svelte-c7d174{display:grid;position:fixed;top:0;left:100%;height:100%;width:100%;max-height:100vh;max-width:100vw;transition:left 0.3s ease-in-out;background-color:rgba(255,255,255,1);grid-template-areas:"left right"\n			"links links";grid-template-columns:1fr 1fr;grid-template-rows:4rem 1fr}#links.active.svelte-c7d174.svelte-c7d174{left:0%}#links.svelte-c7d174>.left.svelte-c7d174{grid-area:left}#links.svelte-c7d174>.right.svelte-c7d174{grid-area:right}#logo.svelte-c7d174.svelte-c7d174{grid-area:logo;display:flex;max-height:100%;overflow:hidden}#logo.svelte-c7d174 b.svelte-c7d174{display:flex;align-items:center}#expander.svelte-c7d174.svelte-c7d174{grid-area:expander}.right.svelte-c7d174.svelte-c7d174{display:flex;align-items:center;justify-content:end;padding-right:0.5rem}ul.svelte-c7d174.svelte-c7d174{position:relative;padding:0;margin:0;display:flex;flex-direction:column;justify-content:center;align-items:center;list-style:none;background-size:contain;grid-area:links}li.svelte-c7d174.svelte-c7d174{position:relative;height:100%}nav.svelte-c7d174 a.svelte-c7d174{display:flex;height:100%;align-items:center;padding:0 1em;color:var(--heading-color);text-decoration:none;transition:color 0.2s linear}a.svelte-c7d174.svelte-c7d174:hover{color:var(--accent-color)}@media screen and (min-width: 500px){nav.svelte-c7d174.svelte-c7d174{grid-template-areas:"logo expander"\n				"links links"}#expander.svelte-c7d174.svelte-c7d174{visibility:hidden}#links.svelte-c7d174.svelte-c7d174{position:relative;display:flex;left:0;grid-area:links;justify-content:center}#links.svelte-c7d174 .left.svelte-c7d174,#links.svelte-c7d174 .right.svelte-c7d174{display:none}#links.svelte-c7d174 ul.svelte-c7d174{flex-direction:row}}',
      map: null
    };
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_page();
      return `<header class="${"svelte-c7d174"}"><nav class="${"svelte-c7d174"}"><section id="${"logo"}" class="${"left svelte-c7d174"}"><img src="${"/favicon.png"}" alt="${"Organization logo"}">
			<b class="${"container svelte-c7d174"}">Chicago Environmental Justice Network
			</b></section>
		<section id="${"expander"}" class="${"right svelte-c7d174"}"><button class="${"button"}">\u2630
			</button></section>
		<section id="${"links"}" class="${["svelte-c7d174", ""].join(" ").trim()}"><section class="${"left svelte-c7d174"}"></section>
			<section class="${"right svelte-c7d174"}"><button class="${"button flat"}">X
				</button></section>
			<ul class="${"svelte-c7d174"}"><li class="${["svelte-c7d174", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-c7d174"}">Home</a></li>
				<li class="${["svelte-c7d174", $page.path === "/about" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/about"}" class="${"svelte-c7d174"}">About Us</a></li>
				<li class="${["svelte-c7d174", $page.path === "/our-stories" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-c7d174"}">Our Stories</a></li>
				<li class="${["svelte-c7d174", $page.path === "/in-the-news" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-c7d174"}">CEJN in the News</a></li>
				<li class="${["svelte-c7d174", $page.path === "/who-are-we" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-c7d174"}">Who is CEJN</a></li>
				<li class="${["svelte-c7d174", $page.path === "/press-releases" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-c7d174"}">Press</a></li>
				<li class="${["svelte-c7d174", $page.path === "/contact" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-c7d174"}">Contact</a></li></ul></section></nav>
</header>`;
    });
    css = {
...
// .svelte-kit/output/server/chunks/error-fbddf85c.js
var error_fbddf85c_exports = {};
__export(error_fbddf85c_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/index-25c4007b.js
var index_25c4007b_exports = {};
__export(index_25c4007b_exports, {
  default: () => Routes,
  prerender: () => prerender
});
var import_cookie3, css2, prerender, Routes;
var init_index_25c4007b = __esm({
  ".svelte-kit/output/server/chunks/index-25c4007b.js"() {
    init_shims();
    init_app_5b189048();
...
// .svelte-kit/output/server/chunks/about-37a80411.js
var about_37a80411_exports = {};
__export(about_37a80411_exports, {
  default: () => About,
  hydrate: () => hydrate,
...
<div class="${"content svelte-cf77e8"}"></div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/index-b9cdd856.js
var index_b9cdd856_exports = {};
__export(index_b9cdd856_exports, {
  default: () => Todos,
  load: () => load2
});
var import_cookie5, css4, load2, Todos;
var init_index_b9cdd856 = __esm({
  ".svelte-kit/output/server/chunks/index-b9cdd856.js"() {
    init_shims();
    init_app_5b189048();
...
// .svelte-kit/output/server/chunks/app-5b189048.js
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-e97d6c8c.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-e97d6c8c.js", assets + "/_app/chunks/vendor-8f6b369f.js"]
    },
    fetched: void 0,
    floc: false,
...
${``}`;
    ...
    module_lookup = {
      "src/routes/__layout.svelte": () => Promise.resolve().then(() => (init_layout_2f514da9(), layout_2f514da9_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_fbddf85c(), error_fbddf85c_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_25c4007b(), index_25c4007b_exports)),
      "src/routes/about.svelte": () => Promise.resolve().then(() => (init_about_37a80411(), about_37a80411_exports)),
      "src/routes/todos/index.svelte": () => Promise.resolve().then(() => (init_index_b9cdd856(), index_b9cdd856_exports))
    };
    metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-026e9266.js", "css": ["assets/pages/__layout.svelte-7e9f9d62.css"], "js": ["pages/__layout.svelte-026e9266.js", "chunks/vendor-8f6b369f.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-adca5ed3.js", "css": [], "js": ["error.svelte-adca5ed3.js", "chunks/vendor-8f6b369f.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-ac4edf6d.js", "css": ["assets/pages/index.svelte-33853948.css"], "js": ["pages/index.svelte-ac4edf6d.js", "chunks/vendor-8f6b369f.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-39314116.js", "css": ["assets/pages/about.svelte-bf4528fa.css"], "js": ["pages/about.svelte-39314116.js", "chunks/vendor-8f6b369f.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-86fd6342.js", "css": ["assets/pages/todos/index.svelte-784042c1.css"], "js": ["pages/todos/index.svelte-86fd6342.js", "chunks/vendor-8f6b369f.js"], "styles": [] } };
  }
});
